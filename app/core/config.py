...
# Matches the real template: A = SL NO (left blank), B = EID NO.,
# C = EMPLOYEE NAME, D = DESIGNATION, E-I = shift columns (left blank).
TIMESHEET_COLUMNS = {
    "eid_no": "B",
    "employee_name": "C",
    "designation": "D",
...
TIMESHEET_FIRST_DATA_ROW = 8  # row 7 is the header row - data starts one row below it
